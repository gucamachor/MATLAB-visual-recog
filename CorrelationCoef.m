...
disp('Práctica 6: Reconocimiento de imágenes en MALTAB')
disp(' ')
global photo0;
photo0 = imread('C:\Users\gucam\OneDrive\Desktop\Práctica 6 - Visión\tuerca1.png');
axes(handles.axes7)
imshow(photo0)
...
% handles    structure with handles and user data (see GUIDATA)
global photo1;
photo1 = imread('C:\Users\gucam\OneDrive\Desktop\Práctica 6 - Visión\tuerca1.png');
axes(handles.axes1)
imshow(photo1)
...
% handles    structure with handles and user data (see GUIDATA)
global photo2;
photo2 = imread('C:\Users\gucam\OneDrive\Desktop\Práctica 6 - Visión\tuerca2.png');
axes(handles.axes2)
imshow(photo2)
...
% handles    structure with handles and user data (see GUIDATA)
global photo3;
photo3 = imread('C:\Users\gucam\OneDrive\Desktop\Práctica 6 - Visión\tuerca3.png');
axes(handles.axes3)
imshow(photo3)
...
% Part size, previously measured
tuerca1 = "1.1 cm.";
set(handles.edit1,'String', tuerca1);
tuerca2 = "1.4 cm.";
set(handles.edit2,'String', tuerca2);tuerca3 = "8.5 cm.";
set(handles.edit3,'String', tuerca3);
tuerca4 = "0.9 cm.";
%set(handles.edit2,'String', tuerca4)
tuerca5 = "2.6 cm.";
%set(handles.edit1,'String', tuerca5)
tuerca0 = "5.0 cm.";
%set(handles.edit1,'String', tuerca0)
